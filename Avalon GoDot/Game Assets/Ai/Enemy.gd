...
func _physics_process(delta):
	...
	if attacking == true and $AnimatedSprite.animation == "Attack" and $AnimatedSprite.frame == 9 and dying == false:
		emit_signal("attack_signal", 5)
